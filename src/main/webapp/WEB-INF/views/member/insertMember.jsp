...
<div class="container">
    <form class="form-wrap" role="form" method="post">
        ...
        <div class="mb15">
            <label><input type="checkbox" class="checkbox"><div><em></em></div><span class="checkbox-txt">[선택] <a href="agreemarketing" class="red bold" target="_blank">마케팅 활용 및 정보 수신</a> 동의합니다.</span></label>
        </div>
