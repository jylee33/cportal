...
var Main = {
    ...
    initDesign: function () {
        ...
        HmGrid.create($lineGrid, {
            ...
            columns: [
                ...
                {text: '대역폭', datafield: 'lineWidth', width: '7%', editable: false, cellsalign: 'right', cellsrenderer: HmGrid.unit1000renderer},
                ...
                {text: '등록일', datafield: 'regUpd', width: '10%', cellsalign: 'center', editable: false}
            ]
    ...
    editLine: function () {
        ...
        Server.post('/Gyeongischool4/lms/lineMgmt/editLine.do', {
            data: {list: _list},
    ...
    delLine: function () {
        ...
        $.each(rowIdxes, function (idx, value) {
            ...
            _list.push({educenterCode: tmp.educenterCode, mngNo: tmp.mngNo, ifIdx: tmp.ifIdx});
            _uids.push(tmp.uid);
        });

        Server.post('/Gyeongischool4/lms/lineMgmt/delLine.do', {
            data: {list: _list},
            success: function (result) {
