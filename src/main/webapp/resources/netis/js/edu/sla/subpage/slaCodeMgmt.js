...
SlaCodeMgmt.prototype = function () {
    ...
    var initDesign = function () {
        ...
        console.log("/edu/sla/subpage/slaCodeMgmt.do?initDesign");
        ...
        HmDropDownList.create($('#sCodeKind'), {
            source: [
                ...
                {label: '신청분류', value: 'APP_KIND_CD'},
                {label: '처리상태', value: 'APP_STAT_CD'},
                {label: '회선상태', value: 'LINE_STAT_CD'},
                {label: '거리', value: 'DISTANCE_CD'},
    ...
    var setGridColumns = function () {
        ...
        var _columns = [
            ...
            {text: '코드ID', datafield: 'cdId', width: 100, cellsalign: 'right', hidden: true},
            {text: '코드명', datafield: 'cdNm', width: 200},
            {text: '코드값', datafield: 'cdVal1', width: 200},
        ...
        if (_codeKind == 'ISP_CD') {
            ...
            _columns.splice(3, 0,
                ...
                {text: '할인율(%)', datafield: 'cdVal3', width: 200, cellsalign: 'right', cellsrenderer: 'number'});
        }
    ...
    var search = function () {
        ...
        console.log("edu slaCodeMgmt : search");
    ...
    var add = function () {
        ...
        if (_cdKind == 'ISP_CD') {
            ...
            $.post(ctxPath + '/main/popup/sla/pSlaCode_ispCd.do',
                params,
                function (result) {
                    HmWindow.open($('#pwindow'), '통신사 추가', result, 400, 220, 'pwindow_init', params);
                }
            );
        ...
        } else if (_cdKind == "APP_STAT_CD") {

            $.post(ctxPath + '/main/popup/sla/pSlaCode_appStatCd.do',
                params,
                function (result) {
                    HmWindow.open($('#pwindow'), '처리상태 추가', result, 400, 290, 'pwindow_init', params);
                }
            );

        } else if (_cdKind == "APP_KIND_CD") {

            $.post(ctxPath + '/main/popup/sla/pSlaCode_appKindCd.do',
                params,
                function (result) {
                    HmWindow.open($('#pwindow'), '신청분류 추가', result, 400, 290, 'pwindow_init', params);
                }
            );

        } else if (_cdKind == 'LINE_STAT_CD') {

            $.post(ctxPath + '/main/popup/sla/pSlaCode_lineStatCd.do',
                params,
                function (result) {
                    HmWindow.open($('#pwindow'), '회선상태 수정', result, 400, 290, 'pwindow_init', params);
                }
            );
    ...
    var edit = function () {
        ...
        if (_cdKind == 'ISP_CD') {
            ...
            $.post(ctxPath + '/main/popup/sla/pSlaCode_ispCd.do',
                params,
                function (result) {
                    HmWindow.open($('#pwindow'), '통신사 수정', result, 400, 280, 'pwindow_init', params);
                }
            );
            ...
            $.post(ctxPath + '/main/popup/sla/pSlaCode_speedAmtCd.do',
                params,
                function (result) {
                    HmWindow.open($('#pwindow'), '이용요금 수정', result, 400, 350, 'pwindow_init', params);
                }
            );
            ...
            $.post(ctxPath + '/main/popup/sla/pSlaCode_appStatCd.do',
                params,
                function (result) {
                    HmWindow.open($('#pwindow'), '처리상태 수정', result, 400, 290, 'pwindow_init', params);
                }
            );
            ...
            $.post(ctxPath + '/main/popup/sla/pSlaCode_appKindCd.do',
                params,
                function (result) {
                    HmWindow.open($('#pwindow'), '신청분류 수정', result, 400, 290, 'pwindow_init', params);
                }
            );
