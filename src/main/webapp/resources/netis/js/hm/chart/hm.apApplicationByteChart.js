 ...
 * @constructor
 */
var ApApplicationByteChart = function(chartId, chartInfo) {
    this.chartId = chartId;
    this.chart = null;
};

ApApplicationByteChart.prototype = function() {
    ...
    var initialize = function() {
        this.chart =
            HmHighchart.createStockChart(this.chartId, {
                ...
                series: [
                    {name: 'APP명', type: 'pie', color: '#2196c2'}
...
*/
    ...
    var searchDataResult = function(params, result) {
        ...
        chartDataArr = HmHighchart.convertJsonArrToChartDataArr('appName', ['appUasge'], result);
