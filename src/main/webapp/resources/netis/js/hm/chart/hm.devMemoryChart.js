 ...
 * @constructor
 */
var DevMemoryChart = function(chartId) {
    this.chartId = chartId;
    this.chart = null;
};

DevMemoryChart.prototype = function() {
    ...
    var initialize = function() {
        this.chart =
            HmHighchart.createStockChart(this.chartId, {
                ...
                series: [
                    {name: 'MEMORY 평균', type: 'area'},
                    {name: 'MEMORY 최대', type: 'line'},
                    {name: 'MEMORY 최소', type: 'line', visible: false}
                    //{name: 'MEMORY 최대', type: 'line', lineWidth: 0, marker: {enabled: true, radius: 4, symbol: 'diamond'}, visible: false}
                ]
