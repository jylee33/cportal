 ...
 * @constructor
 */
var IfThresholdChart = function(chartId) {
    this.chartId = chartId;
    this.chart = null;
};

IfThresholdChart.prototype = function() {
    ...
    var searchData = function(params) {
        ...
        var _chartType = params.chartName.split("_").slice(-1).toString().toUpperCase();
        params.chartType = _chartType;
        perfData.searchIfThresholdPerf(_this, params, searchDataResult);
    ...
    var searchDataResult = function(params, result) {
        ...
        var _holdMaxLine = 0;
        var _holdFiveMaxLine = 0;
        _holdMaxLine = result.holdMaxLine;
        _holdFiveMaxLine = result.holdFiveMaxLine;
        ...
        if ('holdLineName' in params) {
            if (dataList === undefined) {
                ...
                // params.holdLineName.html("권장임계치 : " + _holdMaxLine + "%") // 상위 5%~15%의 평균
                params.holdLineName.html("권장임계치 : " + _holdFiveMaxLine + "%") // 상위5%
            }
        }
        ...
        if (this.chart.series) {
            ...
            // redrawAxisPlotLines.call(this, _holdMaxLine,"임계치"); // 상위 5%~15%의 평균
            redrawAxisPlotLines.call(this, _holdFiveMaxLine, "임계치"); // 상위5%
