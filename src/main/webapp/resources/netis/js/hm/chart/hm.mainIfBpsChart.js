...
var MainIfBpsChart = function (chartId) {
    this.chartId = chartId;
    this.chart = null;
};

MainIfBpsChart.prototype = function () {
    ...
    var initialize = function () {
        this.chart =
            HmHighchart.createStockChart(this.chartId, {
                ...
                series: [
                    {name: 'UTM #1 IN 최대', type: 'line'},
                    {name: 'UTM #1 OUT 최대', type: 'line'},
                    {name: 'UTM #2 IN 최대', type: 'line'},
                    {name: 'UTM #2 OUT 최대', type: 'line'},
                ],
                userOptions: {
                    chartConfig: {
