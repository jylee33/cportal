 ...
 * @constructor
 */
var SvrFileSystemChart = function(chartId, chartInfo) {
...
SvrFileSystemChart.prototype = function() {
        ...
        this.chart =
            HmHighchart.createStockChart(this.chartId, {
                ...
                tooltip: {
                    ...
                    useHTML: true,
                    valueSuffix: ' %',
                    formatter: HmHighchart.absUnit1024TooltipFormatter
                },
                series: [
...
*/
    ...
    var searchDataResult = function(params, result) {
        ...
        chartDataArr = HmHighchart.convertJsonArrToChartDataArr('DT_YMDHMS', ['PERF_AVG'], result);
        // if(params.tableCnt == 1) {
