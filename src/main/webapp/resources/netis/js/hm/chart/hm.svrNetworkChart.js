 ...
 * @constructor
 */
var SvrNetworkChart = function(chartId, chartInfo) {
...
SvrNetworkChart.prototype = function() {
    ...
    var initialize = function() {
        ...
        this.chart =
            HmHighchart.createStockChart(this.chartId, {
                ...
                series: [
                    {name: this.seriesName + ' IN 평균', type: 'area'},
                    {name: this.seriesName + ' OUT 평균', type: 'area'},
                    {name: this.seriesName + ' IN 최대', type: 'line'},
                    {name: this.seriesName + ' OUT 최대', type: 'line'},
                    {name: this.seriesName + ' IN 최소', type: 'line', visible: false},
                    {name: this.seriesName + ' OUT 최소', type: 'line', visible: false}
