 ...
 * @constructor
 */
var VmBpsChart = function(chartId, vsvrKind) {
    this.chartId = chartId;
    this.vsvrKind = vsvrKind;
    this.chart = null;
};

VmBpsChart.prototype = function() {
    ...
    var searchDataResult = function(params, result) {
        ...
        chartDataArr = HmHighchart.convertJsonArrToChartDataArr('DT_YMDHMS', ['PERF_IN_BPS_AVG', 'PERF_OUT_BPS_AVG', 'PERF_IN_BPS_MAX', 'PERF_OUT_BPS_MAX', 'PERF_IN_BPS_MIN', 'PERF_OUT_BPS_MIN'], result);
