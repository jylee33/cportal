 ...
 * @constructor
 */
var VmPpsChart = function (chartId, vsvrKind) {
    this.chartId = chartId;
    this.vsvrKind = vsvrKind;
    this.chart = null;
};

VmPpsChart.prototype = function () {
    ...
    var searchData = function (params) {
        ...
        console.log("searchData : " + JSON.stringify(params));
    ...
    var searchDataResult = function (params, result) {
        ...
        chartDataArr = HmHighchart.convertJsonArrToChartDataArr('DT_YMDHMS', ['PERF_IN_PPS_AVG', 'PERF_OUT_PPS_AVG', 'PERF_IN_PPS_MAX', 'PERF_OUT_PPS_MAX', 'PERF_IN_PPS_MIN', 'PERF_OUT_PPS_MIN'], result);
