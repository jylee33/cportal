...
var Main = {
    ...
    initDesign: function() {
        ...
        $treeGrid.jqxTreeGrid(
            {
                ...
                altRows: false,
                columns: [
                    { text: '번호',		datafield: 'boardNo', align: 'center', width: 50 },
                    ...
                    { text: '작성자',		datafield: 'userName',	align: 'center', width: 70 , columntype: 'custom',
                        cellsrenderer: function(row, column, value, rowData) {
                    ...
                    { text: checkFlagStr_txt,		datafield: 'checkFlagStr',	align: 'center',	cellsalign: 'center', width: 100, cellsrenderer: HmGrid.boardStatusrenderer }
                ]
            })
        ...
        $treeGrid.on('rowDoubleClick', function (event) {
            ...
            window.location.href=$('#ctxPath').val() +'/main/board/pSupportBoardContents.do?boardNo='+itemget;
        });
    },
    ...
    checkWrite: function() {
        ...
        if(result != null && size !=0){
            location.href=$('#ctxPath').val() +'/main/board/pSupportBoardWrite.do';
        }else{
