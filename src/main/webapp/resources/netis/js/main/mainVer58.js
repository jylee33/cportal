...
// 장애처리 게시판
    ...
    showNoticeBoard : function() {
        HmUtil.createPopup('/main/board/pNoticeBoardList.do', $('#hForm'), 'pNoticeBoard', 700, 565);
    },
    /** 공지 게시판 컨텐츠 보기 */
    showNoticeBoardContent : function(_boardNo) {
        var params = { boardNo : _boardNo };
        HmUtil.createPopup('/main/board/pNoticeBoardContents.do', $('#hForm'), 'pNoticeBoard', 700, 565, params);
    },
    ...
    showSupportBoard : function() {
        HmUtil.createPopup('/main/board/pSupportBoardList.do', $('#hForm'), 'pSupportBoard', 700, 565);
    },
    /** 기술지원 게시판 컨텐츠 보기 */
    showSupportBoardContent : function(_boardNo) {
        var params = { boardNo : _boardNo };
        HmUtil.createPopup('/main/board/pSupportBoardContents.do', $('#hForm'), 'pSupportBoard', 700, 565, params);
    },
    /** 이벤트 게시판 */
