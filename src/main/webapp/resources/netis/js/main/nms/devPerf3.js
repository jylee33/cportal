	...
	initDesign: function() {
		...
		HmGrid.create($devGrid, {
			...
			[
				...
				{ text : '장비명', columngroup: 'devInfo', datafield: 'disDevName', width: 230, cellsrenderer: HmGrid.devNameRenderer },
				...
				{ text : '장비종류', columngroup: 'devInfo', datafield: 'devKind2', width: 130, filtertype: 'checkedlist' },
				{ text : '제조사', columngroup: 'devInfo', datafield: 'vendor', width: 130, filtertype: 'checkedlist' },
				{ text : '모델', columngroup: 'devInfo', datafield: 'model', width: 180, filtertype: 'checkedlist' },
				...
				// { text : 'Crc', columngroup: 'crc', datafield: 'crc', width: 80, cellsalign: 'right' , hidden : true},
				// { text : 'OUT', columngroup: 'error', datafield: 'inError', width: 80, cellsalign: 'right' , hidden : true},
				// { text : 'IN', columngroup: 'error', datafield: 'outError', width: 80, cellsalign: 'right' , hidden : true},
			],
			columngroups:
			[
				...
				// { text: 'CRC(개수)', align: 'center', name: 'crc' , hidden: true},
				// { text: 'ERROR(개수)', align: 'center', name: 'error', hidden: true }
			]
		...
		$devGrid.on('rowdoubleclick', function(event) {
			...
			.on('bindingcomplete', function(event) {
				try {
					$(this).jqxGrid('sortby', 'cpuCurrency', 'desc');
