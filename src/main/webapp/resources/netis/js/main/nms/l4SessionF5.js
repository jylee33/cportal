...
var Main = {
    ...
    /** init design */
    initDesign: function() {
        // HmTreeGrid.create($grpTree, HmTree.T_GRP_DEFAULT2, Main.selectTree, {devKind2: 'L7SWITCH,L7 SWITCH,L4SWITCH,L4 SWITCH', isPerfFlag: 1 , vendor:'F5'});
        HmTreeGrid.create($grpTree, HmTree.T_L4_F5_GRP_DEFAULT, Main.selectTree, {devKind2: 'L7SWITCH,L4SWITCH', isPerfFlag: 1 , vendor:'F5'});
        ...
        HmGrid.create($virtualGrid, {
            source: new $.jqx.dataAdapter(
                {
                    ...
                    datafields: [
                        ...
                        { name: 'totConn', type: 'number' },
                        { name: 'maxConn', type: 'number' },
            ...
            columns:
                [
                    ...
                    { text: 'Protocol', datafield: 'protocol', width: 100, cellsalign: 'center' },
                    { text: 'PORT', datafield: 'port', width: 80, cellsalign: 'right' },
                    { text: 'Virtual 그룹명', datafield: 'svrGrpNm', width: 150 },
                    // { text: 'Status', datafield: 'dispStatus', width: 80, cellsalign: 'center', cellsrenderer: HmGrid.l4f5VirtualStatusRenderer },
                    { text: 'Status', datafield: 'dispStatus', width: 80, cellsalign: 'center', cellsrenderer: Main.l4f5StatusRenderer },
                    { text: "In bps", datafield: "inBps", width: 100, cellsalign: 'right', cellsrenderer: HmGrid.unit1000renderer },
                    { text: "Out bps", datafield: "outBps", width: 100, cellsalign: 'right', cellsrenderer: HmGrid.unit1000renderer },
                    { text: "현재 세션수", datafield: "currConn", width: 100, cellsalign: 'right', cellsformat: 'n' },
                    { text: "총 세션수", datafield: "totConn", width: 100, cellsalign: 'right', cellsformat: 'n' },
                    { text: "최대 세션수", datafield: "maxConn", width: 100, cellsalign: 'right', cellsformat: 'n' },
                    { text: "CPS", datafield: "cps", width: 100, cellsalign: 'right', cellsformat: 'n' },
                    { text: "최종수집일시", datafield: "lastUpd", width: 160, cellsalign: 'center' }
                ]
        }, CtxMenu.L4_F5_VIRTUAL, 'virtual');
        ...
        HmGrid.create($realGrid, {
            ...
            showtoolbar: true,
            rendertoolbar: function (toolbar) {
                HmGrid.titlerenderer(toolbar, 'Real Server 세션성능 <span class="pop_tooltip01"></span>');
            },
            columns:
            [
        ...
        }, CtxMenu.L4_F5_REAL, 'real');
        $(".pop_tooltip01").jqxTooltip({ content: '<b>NONE : error / GREEN : available in some capacity<br>YELLOW : not currently available / RED : not available<br>BLUE : availability is unknown / GRAY : unlicensed</b>', position: 'right', name: 'groupTooltip', theme: '' });
    },
    ...
    searchVirtualSvr: function() {
        HmGrid.updateBoundData($virtualGrid, ctxPath + '/main/nms/l4SessionF5/getVirtualList.do');
    },

    /** Real 조회 */
    searchRealSvr: function() {
        HmGrid.updateBoundData($realGrid, ctxPath + '/main/nms/l4SessionF5/getRealList.do');
    },
    ...
    /*
        L7Switch Real의 상태값 (F5기준) 2023.01.07 status 값에 따라 색상 표기 변경
    */
    l4f5StatusRenderer: function (row, datafield, value, defaulthtml, columnproperties, rowdata) {
        var clz = rowdata.status;
        switch(clz){
            case 0 : clz = 'none'; break;
            case 1 : clz = 'green'; break;
            case 2 : clz = 'yellow'; break;
            case 3 : clz = 'red'; break;
            case 4 : clz = 'blue'; break;
            case 5 : clz = 'gray'; break;
        }
