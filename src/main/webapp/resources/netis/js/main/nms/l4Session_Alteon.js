...
var Main = {
		...
		initDesign: function() {
			...
			HmTreeGrid.create($grpTree, HmTree.T_L4_GRP_DEFAULT, Main.search, {model: 'Alteon'});
	    	...
	    	HmGrid.create($l4Grid, {
				...
				[
					...
					{ text: '관리IP수', datafield: 'rIpCnt', width: 100, cellsalign: 'right', cellsformat: 'n' },
		...
		search: function() {
			...
			HmGrid.updateBoundData($l4Grid, ctxPath + '/main/nms/l4Session_Alteon/getL4Session_AlteonList.do');
		},
		...
		searchChart: function(rowdata) {
			...
			Server.get('/main/nms/l4Session_Alteon/getL4Session_AlteonChartList.do', {
				data: params,
		...
		exportExcel: function() {
			HmUtil.exportGrid($l4Grid, 'L4세션_Alteon', false);
			return;

			var params = Main.getCommParams();
			HmUtil.exportExcel(ctxPath + '/main/nms/l4Session_Alteon/export.do', params);
		},
		...
		showChartData: function(type) {
			...
			case 'sess':
				cols = [
			            ...
			            { text: '평균세션수', datafield: 'avgRSessCnt', cellsalign: 'right', cellsformat: 'n', width: 150 },
			            { text: '최대세션수', datafield: 'maxRSessCnt', cellsalign: 'right', cellsformat: 'n', width: 150 }
		            ];
			...
			case 'perf':
				cols = [
			            { text: '일시', datafield: 'ymdhms' },
			            { text: '평균CPS', datafield: 'avgRSessCps', cellsalign: 'right', cellsformat: 'n', width: 150 },
			            { text: '최대CPS', datafield: 'maxRSessCps', cellsalign: 'right', cellsformat: 'n', width: 150 }
		            ];
