...
var Main = {
                ...
                },
                {
                    ...
                    loadComplete: function (record) {
                        ...
                        Server.post('/main/nms/slmMgmt/getRateList.do', {
                            data: {code: "BROAD", codeId: "ACCUMULATE"},
    ...
    addEvt: function () {
        ...
        $.ajax({
            ...
            success: function (result) {
                HmWindow.openFit($("#pwindow"), "방송망 장애 등록", result, 500, 380);
            }
        });
    ...
    exportExcel: function () {
        ...
        HmUtil.exportGridSlm($errProcessGrid, "SLM 장애관리(방송시스템)", true, params);
