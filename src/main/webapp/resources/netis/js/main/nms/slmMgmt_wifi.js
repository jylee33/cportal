...
var Main = {
        ...
        HmGrid.create($errProcessGrid, {
            ...
            columns:
                [
                    ...
                    {text: '의견', datafield: 'adminProcessMemo', width: 120, columngroup: "admin", cellsalign: 'center'},
                    {text: 'Status', datafield: 'dispStatus', width: 80, cellsalign: 'center', hidden: true},
                    {text: "최종수집일시", datafield: "lastUpd", width: 160, cellsalign: 'center', hidden: true}
                ],
            columngroups: [
    ...
    exportExcel: function () {
        HmUtil.exportMultiGrid($errNoticeGrid, $errProcessGrid, "SLM 장애관리(와이파이망)", true, null);
