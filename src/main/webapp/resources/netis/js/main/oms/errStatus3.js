...
var Main = {
    ...
    setEvtCodeGrpState: function () {
        ...
        var stateSpan = $('#evtCodeGrpTable div.errEffect');
        ...
        if (rows != null && rows.length > 0) {
                ...
                if (Object.keys(evtMap)[i] !== 'all' && Object.keys(evtMap)[i] !== 'etc') {
                    ...
                    $.each(rows, function (evtIdx, evtItem) {
                        ...
                        if ( evtCodeMap[Object.keys(evtCodeMap)[i]].findIndex(v => v === evtItem.code) > -1 ) {
                            //if ( parseInt(Object.keys(evtMap)[i]) == evtCodeMap[evtItem.code] ) {
                    ...
                    evtMap.etc.cnt -=  evtMap[parseInt(Object.keys(evtMap)[i])].cnt;
                }
            }
            ...
            stateSpan.text('정상');
            stateDiv.removeClass().addClass('eventBg normal');
