...
var Main = {
		...
		initDesign: function() {
			...
			var source =
            {
                ...
                id: 'boardNo',
                url: $('#ctxPath').val() + '/main/oms/qnaBoard/getBoardList.do'
            };
		...
		checkWrite: function() {
			...
			if(result != null && size !=0){
				HmUtil.createPopup('/main/board/pQnaBoardWrite.do', $('#hForm'), 'pSupportBoardWrite', 1000, 620);
			}else{
		...
		popContents: function(_boardNo) {
			...
			HmUtil.createPopup('/main/board/pQnaBoardContents.do', $('#hForm'), 'pSupportBoardContents', 1000, 620, params);
		},
