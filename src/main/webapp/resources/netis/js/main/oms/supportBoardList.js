...
//		this.search();
		...
		if (result != null && size != 0) {
			HmUtil.createPopup('/main/board/pSupportBoardWrite.do', $('#hForm'), 'pSupportBoardWrite', 700, 565);
		} else {
	...
	popContents : function(_boardNo) {
		...
		HmUtil.createPopup('/main/board/pSupportBoardContents.do', $('#hForm'), 'pSupportBoardContents', 700, 565, params);
	},
