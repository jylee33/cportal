...
var PMain = {
	...
	initDesign: function() {
		...
		HmGrid.create($p_sectPerfGrid, {
			...
			columns: 
			[
				{ text : '그룹명(Source)', datafield : 'grpName', minwidth : 150, editable : false },
				...
				{ text : 'Source 장비명', datafield: 'devName', minwidth: 150, editable: false },
				...
				{ text : 'Target 장비명', datafield: 'dstDevName', minwidth: 150, editable: false },
	...
	add: function() {
		$.post(ctxPath + '/main/popup/nms/pSectPerf3Add.do', function(result) {
			HmWindow.open($('#pwindow'), '구간성능 설정  등록', result, 500, 200, 'pwindow_init', PMain.getCommParams());
		});
	},
	...
	save: function() {
		...
		Server.post('/main/nms/devPerf3/editSectionPerf.do', {
			data: { list: _list },
	...
	del: function() {
		...
		Server.post('/main/nms/devPerf3/delSectionPerf.do', {
	...
	search: function() {
		HmGrid.updateBoundData($p_sectPerfGrid, ctxPath + '/main/nms/devPerf3/getSectionPerfConfList.do');
	}
};
