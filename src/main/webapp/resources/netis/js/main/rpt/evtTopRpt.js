...
var Main = {
		...
		initDesign : function() {
			...
			HmGrid.create($rptGrid, {
				...
				[
				 	...
				 	{ text: 'PING 장애', datafield: 'icmp01Cnt', width: 150, cellsformat: 'n', cellsalign: 'right' },
				 	{ text: 'CPU', datafield: 'perf05Cnt', width: 150, cellsformat: 'n', cellsalign: 'right' },
				 	{ text: 'MEMORY', datafield: 'perf06Cnt', width: 150, cellsformat: 'n', cellsalign: 'right' },
				 	{ text: 'IF-DOWN', datafield: 'trap02Cnt', width: 150, cellsformat: 'n', cellsalign: 'right' },
				 	{ text: '성능장애', datafield: 'perf01Cnt', width: 150, cellsformat: 'n', cellsalign: 'right' }
			    ]
			});
		},
		...
		/** 조회 */
		search : function() {
			HmGrid.updateBoundData($rptGrid, ctxPath + '/main/rpt/evtTopRpt/getEvtTopList.do');
		}
};
