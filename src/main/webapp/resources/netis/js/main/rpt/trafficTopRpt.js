...
var Main = {
		...
		initDesign : function() {
			...
			HmGrid.create($rptGrid, {
				...
				[
				 	...
				 	{ text: '할당대역폭', datafield: 'lineWidth', width: 150, cellsrenderer: HmGrid.unit1000renderer },
				 	{ text: '최대', datafield: 'maxInbps', width: 150, cellsrenderer: HmGrid.unit1000renderer },
				 	{ text: '최소', datafield: 'minInbps', width: 150, cellsrenderer: HmGrid.unit1000renderer },
				 	{ text: '평균', datafield: 'avgInbps', width: 150, cellsrenderer: HmGrid.unit1000renderer }
			    ]
			});
		},
		...
		/** 조회 */
		search : function() {
			HmGrid.updateBoundData($rptGrid, ctxPath + '/main/rpt/trafficTopRpt/getTrafficTopList.do');
		}
};
