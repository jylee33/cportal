...
var Main = {
		...
		eventControl: function(event) {
			...
			case 'btnSearch_evt': this.searchEvtHist(); break;
            case 'btnSave_evt': this.saveEvtSla(); break;
		...
		initDesign: function() {
            ...
            HmJqxSplitter.create($('#contentSplitter'), HmJqxSplitter.ORIENTATION_H, [{ size: '70%', collapsible: false }, { size: '30%' }], 'auto', '100%');
			...
			$('#sYear').jqxDropDownList({ width: 80, height: 21, theme: jqxTheme,
                source: s_year, selectedIndex: s_year.length-1, autoDropDownHeight: true
            });
			$('#sMonth').jqxDropDownList({ width: 60, height: 21, theme: jqxTheme,
				...
				source: new $.jqx.dataAdapter(
						{
                            ...
                            // 필터위해 미리 추가
                            // datafields:[
                            //     { name:'asgnNo', type:'string' },
                            //     { name:'upGrpName', type:'string' },
                            //     { name:'upDevName', type:'string' },
                            //     { name:'upMngNo', type:'number' },
                            //     { name:'upIfName', type:'string' },
                            //     { name:'upIfIdx', type:'string' },
                            //     { name:'grpName', type:'string' },
                            //     { name:'devName', type:'string' },
                            //     { name:'mngNo', type:'number' },
                            //     { name:'ifName', type:'string' },
                            //     { name:'ifIdx', type:'string' },
                            //     { name:'wireServiceName', type:'string' },
                            //     { name:'calcSlaAmt', type:'number' },
                            //     { name:'calcSlaCharge', type:'number' },
                            //     { name:'errActionCnt', type:'number' },
                            //     { name:'errActionExceedCnt', type:'number' },
                            //     { name:'errActionNotNotiCnt', type:'number' },
                            //     { name:'errRepairExceedCnt', type:'number' },
                            //     { name:'calcErrRepairCharge', type:'number' },
                            //     { name:'errAccrueMinute', type:'string' },
                            //     { name:'calcErrAccrueCharge', type:'number' },
                            //     { name:'errCnt', type:'number' },
                            //     { name:'calcErrOverlapCharge', type:'number' },
                            //     { name:'calcLastMonContErrCnt', type:'number' },
                            //     { name:'calcLast2MonContErrCnt', type:'number' },
                            //     { name:'calcContErrNextCharge', type:'number' },
                            // ],
...
//								alert(JSON.stringify(data));
				...
				columns: 
				[
                    { text : '전용회선번호', datafield : 'asgnNo', width : 120, editable: false, cellsalign: 'center' },
                    { text : '상위 그룹명', datafield : 'upGrpName', width : 130, editable: false },
                    { text : '상위 장비명', datafield : 'upDevName', minwidth: 130, editable: false },
                    { text : '상위 장비', datafield : 'upMngNo', width : 80, editable: false, hidden: true, cellsalign: 'right' },
                    { text : '상위 회선명', datafield : 'upIfName', minwidth: 130, editable: false },
                    { text : '상위 회선', datafield : 'upIfIdx', width : 80, editable: false, hidden: true, cellsalign: 'right' },
                    { text : '하위 그룹명', datafield : 'grpName', width : 130, editable: false
                        // aggregatesrenderer: function () {
                        //     return "<div style='margin-top: 4px;' class='jqx-center-align'>합계</div>";
                        // }
                    },
                    { text : '하위 장비명', datafield : 'devName', minwidth: 130, editable: false },
                    { text : '하위 장비', datafield : 'mngNo', width : 80, editable: false, hidden: true, cellsalign: 'right' },
                    { text : '하위 회선명', datafield : 'ifName', minwidth: 130, editable: false },
                    { text : '하위 회선', datafield : 'ifIdx', width : 80, editable: false, hidden: true, cellsalign: 'right' },
                    { text : '통신사', datafield : 'wireServiceName', width: 60, cellsalign: 'center', editable: false },
					{ text : '월 이용료', datafield : 'calcSlaAmt', width : 100, cellsalign: 'right', cellsformat: 'n', editable: false },
                    { text : '보상 합계', datafield: 'calcSlaCharge', width: 100, cellsalign: 'right', cellsformat: 'n', editable: false,
                        aggregates: ['sum'], aggregatesrenderer: Main.agg_sumrenderer},
                    { text : '통보 건수', columngroup: 'noti', datafield: 'errActionCnt', width: 100, cellsrenderer: Main.cntRenderer, editable: false,
                        aggregates: ['sum'], aggregatesrenderer: Main.agg_sumrenderer},
					{ text : '지연통보 건수', columngroup: 'noti', datafield: 'errActionExceedCnt', width: 100, cellsrenderer: Main.cntRenderer, editable: false,
                        aggregates: ['sum'], aggregatesrenderer: Main.agg_sumrenderer},
                    { text : '미통보 건수', columngroup: 'noti', datafield: 'errActionNotNotiCnt', width: 80, cellsrenderer: Main.cntRenderer, editable: false,
                        aggregates: ['sum'], aggregatesrenderer: Main.agg_sumrenderer},
                /*    { text : '산출시간', columngroup: 'noti', datafield: 'errActionExceedCnt', width: 80, cellsrenderer: Main.hourRenderer, editable: false,
                        aggregates: ['sum'], aggregatesrenderer: Main.agg_sumrenderer},*/
                    { text : '지연건수', columngroup: 'repair', datafield: 'errRepairExceedCnt', width: 60, cellsrenderer: Main.cntRenderer, editable: false,
                        aggregates: ['sum'], aggregatesrenderer: Main.agg_sumrenderer},
             /*       { text : '보상시간', columngroup: 'repair', datafield: 'errRepairExceedHour', width: 80, cellsrenderer: Main.hourRenderer, editable: false,
                        aggregates: ['sum'], aggregatesrenderer: Main.agg_sumrenderer},*/
                    { text : '보상금액', columngroup: 'repair', datafield: 'calcErrRepairCharge', width: 100, cellsrenderer: Main.chargeRenderer, editable: false,
                        aggregates: ['sum'], aggregatesrenderer: Main.agg_sumrenderer},
                    { text : '산출시간', columngroup: 'accrue', datafield: 'errAccrueMinute', width: 80, cellsrenderer: Main.minuteRenderer, editable: false,
                        aggregates: ['sum'], aggregatesrenderer: Main.agg_sumrenderer},
                    { text : '보상금액', columngroup: 'accrue', datafield: 'calcErrAccrueCharge', width: 100, cellsrenderer: Main.chargeRenderer, editable: false,
                        aggregates: ['sum'], aggregatesrenderer: Main.agg_sumrenderer},
                    { text : '건수', columngroup: 'overlap', datafield: 'errCnt', width: 60, cellsrenderer: Main.cntRenderer, editable: false,
                        aggregates: ['sum'], aggregatesrenderer: Main.agg_sumrenderer},
                    { text : '보상금액', columngroup: 'overlap', datafield: 'calcErrOverlapCharge', width: 100, cellsrenderer: Main.chargeRenderer, editable: false,
                        aggregates: ['sum'], aggregatesrenderer: Main.agg_sumrenderer},
                    { text : '2개월연속', columngroup: 'continue', datafield: 'calcLastMonContErrCnt', width: 80, cellsrenderer: Main.contErrRenderer, editable: false },
                    { text : '3개월연속', columngroup: 'continue', datafield: 'calcLast2MonContErrCnt', width: 80, cellsrenderer: Main.contErrRenderer, editable: false },
                    ...
                    //     }
                    // },
                    { text : '익월요금', columngroup: 'continue', datafield: 'calcContErrNextCharge', width: 100, editable: false,
                        cellsrenderer: function(row, datafield, value) {
                            var str = "";
                            if(value == 2){
                                str = "20%할인";
            ...
            HmGrid.create($evtGrid, {
                source: new $.jqx.dataAdapter(
                    ...
                    },
                    {
                        formatData: function(data) {
                            ...
                            if(slaRow != null) {
                                params.sMngNo = slaRow.mngNo;
                                params.sIfIdx = slaRow.ifIdx;
                            }
                            $.extend(data, params);
                            return data;
                        },
                ...
                rendertoolbar: function(toolbar) {
                    HmGrid.titlerenderer(toolbar, '장애이력');
                },
                columns:
                [
                    { text : '이용기관', datafield : 'grpName', width : 150, editable: false, pinned: true },
                    ...
                    { text : '통보일시', datafield : 'evtReceiptdate', width : 160, editable: false },
                    { text : '지속시간', datafield : 'slaSumSec', width : 150, cellsrenderer : HmGrid.cTimerenderer, editable: false },
                    { text : '소명시간', datafield : 'apprExcSlaSumSec', width : 150, cellsrenderer : HmGrid.cTimerenderer, editable: false },
        ...
        slaStateCellclass: function(row, columnfield, value) {
            ...
            switch(row.slaStateCd || 0) {
                case 1: return 'slaState1';
                case 2: case 3: case 4: return "slaState2";
                case 5: return "slaState5";
                case 6: return "slaState6";
                default: return null;
            }
        },
        ...
        agg_sumrenderer: function(aggregates, column) {
            ...
            var suffix = '';
            if($.inArray(column.datafield, ['errActionCnt','errActionExceedCnt','calcErrActionNotNotiCnt','calcErrActionNotNotiCnt','errRepairExceedCnt', 'errCnt']) != -1) {
                suffix = '건';
            }
            ...
            else if($.inArray(column.datafield, ['errAccrueMinute']) != -1) {
                suffix = '분';
            }
		...
		searchSLA: function() {
		    ...
		    HmGrid.updateBoundData($slaGrid, ctxPath + '/main/sla/errMgmtSla/getErrMgmtSlaList.do');
		},

        /** 장애이력 조회 */
        searchEvtHist: function() {
            HmGrid.updateBoundData($evtGrid, ctxPath + '/main/sla/errMgmtSla/getSlaEvtMgmtList.do');
        },
        ...
        reportMgmt: function(row) {
            ...
            var seqNoList = $evtGrid.jqxGrid('getboundrows').map(function(d) { return d.seqNo; });
            var params = {
                seqNo: data.seqNo,
                seqNoList: seqNoList
            };
