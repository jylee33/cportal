...
var Main = {
		...
		/** 조회 */
		search: function() {
			HmGrid.updateBoundData($infoGrid, ctxPath + '/main/sla/slaEvt/getSlaEvtList.do');
		},
        ...
        showReport: function() {
            ...
            HmUtil.createPopup('/main/popup/sla/pSlaEvtReport.do', $('#hForm'), 'pSlaEvtReport', 820, 720, {seqNoList: seqNoList});
        }
