...
var Main = {
		...
		initDesign: function() {
			...
			HmGrid.create($svrGrid, {
				source: new $.jqx.dataAdapter(
						{
							datatype: 'json',
							url: ctxPath + '/main/starcell/itmonCpuCpst/getITMonCpuCpstList.do'
						}
				),
				columns: 
				[
					...
					{ text : 'CPU타입', datafield: 'type', width: 300 },
					{ text : 'CPU개수', datafield: 'count', width: 100, cellsalign: 'right' },
		...
		exportExcel: function() {
			HmUtil.exportGrid($svrGrid, 'CPU구성', false);
		}
};
