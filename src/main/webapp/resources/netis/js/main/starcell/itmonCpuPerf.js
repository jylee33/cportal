...
var Main = {
		...
		initDesign: function() {
			...
			HmGrid.create($svrGrid, {
				source: new $.jqx.dataAdapter(
						{
							datatype: 'json',
							url: ctxPath + '/main/starcell/itmonCpuPerf/getITMonCpuPerfList.do'
						}
				),
				columns: 
				[
					...
					{ text : 'CPU개수', datafield: 'smsCpuNo', width: 100, cellsalign: 'right' },
					{ text : 'CPU사용률(%)', datafield: 'cpuPct', width: 100, cellsalign: 'right' },
					{ text : 'USER사용률(%)', datafield: 'userPct', width: 100, cellsalign: 'right' },
					{ text : 'SYSTEM사용률(%)', datafield: 'systemPct', width: 100, cellsalign: 'right' },
					{ text : 'WAIT사용률(%)', datafield: 'waitioPct', width: 100, cellsalign: 'right' },
		...
		exportExcel: function() {
			HmUtil.exportGrid($svrGrid, 'CPU성능', false);
		}
};
