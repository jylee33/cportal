...
var Main = {
		...
		initDesign: function() {
			...
			HmGrid.create($svrGrid, {
				source: new $.jqx.dataAdapter(
						{
							datatype: 'json',
							url: ctxPath + '/main/starcell/itmonFsysCpst/getITMonFsysCpstList.do'
						}
				),
				columns: 
				[
					...
					{ text : '논리명', datafield: 'logical', width: 100 },
					{ text : '물리명', datafield: 'physical', width: 100 },
					{ text : '전체크기', datafield: 'totalSize', width: 100, cellsrenderer: HmGrid.unit1024renderer },
					{ text : '가용량', datafield: 'freeSize', width: 100, cellsrenderer: HmGrid.unit1024renderer },
		...
		exportExcel: function() {
			HmUtil.exportGrid($svrGrid, '파일시스템구성', false);
		}
};
