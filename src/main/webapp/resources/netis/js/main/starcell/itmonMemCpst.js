...
var Main = {
		...
		initDesign: function() {
			...
			HmGrid.create($svrGrid, {
				source: new $.jqx.dataAdapter(
						{
							datatype: 'json',
							url: ctxPath + '/main/starcell/itmonMemCpst/getITMonMemCpstList.do'
						}
				),
				columns: 
				[
					...
					{ text : '메모리크기', datafield: 'memSize', width: 100, cellsrenderer: HmGrid.unit1024renderer },
					{ text : 'SWAP크기', datafield: 'swapSize', width: 100, cellsrenderer: HmGrid.unit1024renderer },
		...
		exportExcel: function() {
			HmUtil.exportGrid($svrGrid, 'MEM구성', false);
		}
};
