...
var Main = {
		...
		initDesign: function() {
			...
			HmGrid.create($svrGrid, {
				source: new $.jqx.dataAdapter(
						{
							datatype: 'json',
							url: ctxPath + '/main/starcell/itmonNicCpst/getITMonNicCpstList.do'
						}
				),
				columns: 
				[
					...
					{ text : 'NIC명', datafield: 'nif', width: 200 },
					{ text : '해당IP', datafield: 'nicIp', width: 120 },
					{ text : '서브넷', datafield: 'subnetMask', width: 120 },
		...
		exportExcel: function() {
			HmUtil.exportGrid($svrGrid, '월간시스템', false);
		}
};
