...
var Main = {
	...
	createGrid: function() {
		...
		var _fixedCols = [
            ...
            { text: 'Packet Size', datafield: 'pkt_size', width: 100, align: 'center', cellsalign: 'right', cellsformat: 'n', filtertype: 'number'  }
        ];
        var _dynamicCols = [];
	...
	searchData: function() {
		HmGrid.updateBoundData($dataGrid, ctxPath + '/main/tms2/dtlAnalysis/getDtlAnalysisList.do');
	},
