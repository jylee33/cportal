...
var Main = {
	...
	createGrid: function() {
        ...
        HmGrid.create($rawdataGrid, {
            ...
            columns: [
                ...
                { text: '날짜', datafield: 'stamp_inserted_date', width: 130 ,pinned: true, cellsalign: 'center'},
	...
	search : function() {
        ...
        HmGrid.updateBoundData($rawdataGrid, ctxPath + '/main/tms3/rawdataAnalysis/getRawdataAnalysisList.do');
    ...
    exportExcel: function() {
        if(!HmDate.validation($('#date1'), $('#date2'))) return;
        HmUtil.exportExcel(ctxPath + '/main/tms3/rawdataAnalysis/export.do', Main.getCommParams());
    }
