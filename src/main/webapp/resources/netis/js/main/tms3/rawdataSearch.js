...
var Main = {
	...
	initData : function() {
        ...
        Server.get('/main/tms3/rawdataSearch/getRawdataSearchChart.do', {
            data: params,
	...
	createGrid: function() {
        ...
        HmGrid.create($rawdataGrid, {
            ...
            columns: [
                ...
                { text: '날짜', datafield: 'stamp_inserted_date', width: 130 , cellsalign: 'center'},
	...
	getCommParams: function() {
		var params = {
            date: selectedTime,
            // date1: Number($.format.date($('#date1').val('date'), 'yyyyMMddHHmmss')),
	...
	search : function() {
        if(selectedTime != ''){
            HmGrid.updateBoundData($rawdataGrid, ctxPath + '/main/tms3/rawdataSearch/getRawdataAnalysisList.do');
        }
	},
    ...
    exportExcel_after: function(params) {
        HmUtil.exportExcel(ctxPath + '/main/tms3/rawdataSearch/export.do', params);
    },
