...
var Main = {
        ...
        $.each(params.topCond.split(','), function(idx, item) {
            switch(item) {
                case 'SIP':
                    ...
                    // _dynamicCols.push({ text: '출발지 IP', datafield: 'sip', width: 130, align: 'center' });
                    break;
                case 'DIP':
                    ...
                    // _dynamicCols.push({ text: '목적지 IP', datafield: 'dip', width: 130, align: 'center' });
                    break;
                case 'PROTO':
                    ...
                    // _dynamicCols.push({ text: '프로토콜', datafield: 'proto', width: 120, align: 'center',  filtertype: 'checkedlist' , type: 'string'});
                    break;
                case 'SPT':
	...
	searchData: function() {
		...
		HmGrid.updateBoundData($dataGrid, ctxPath + '/main/tms3/trendAnalysis/getTrendAnalysisList.do');
	},
