...
var Main = {
		...
		initDesign: function() {
			...
			HmGrid.create($vmGrid, {
				...
				columns:
				[
                    // { text: 'VM ID', datafield: 'vmUuid', width: '270', hidden: true },
                    ...
                    { text: 'VM 명', datafield: 'vmName', minwidth: '150', pinned: true, cellsrenderer: HmGrid.nutanixVmNameRenderer },
                    ...
                    { text: 'VM IP', datafield: 'ipAddress', width: '110', hidden: true },
