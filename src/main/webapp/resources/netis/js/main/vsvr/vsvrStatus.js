...
var Main = {
		...
		initDesign: function() {
			...
			HmGrid.create($hostGrid, {
				...
				[
				 	...
				 	{ text: '호스트명', datafield: 'devName', minwidth : 130, pinned: true, cellsrenderer: HmGrid.devNameRenderer  },
				 	{ text: '서버명', datafield: 'svrName', minwidth : 130, pinned: true }, // userDevName이 있으면 서버명에 보여주고 없으면 devName...
					...
					{ text: '스토리지 (%)', datafield: 'usedStoragePer', width: 80, cellsformat: "d", cellsalign: "right", filtertype: "number", cellsrenderer:HmGrid.progressbarrenderer }, // datastore
					{ text: 'POWER', datafield: 'power', width: 80, cellsalign: 'right' },
					{ text: 'CPU 코어 수', datafield: 'cores', width: 100, cellsalign: 'right' },
					{ text: 'CPU Hz', datafield: 'totalCpu', width: 100,  cellsformat: "d", cellsrenderer: HmGrid.unitHzRenderer},
					{ text: 'CPU 모델', datafield: 'cpuModel', width: 200 },
					{ text: 'CPU 소켓당 코어 수', datafield: 'socketCore', width: 130, cellsalign: 'right' }
					// { text: '수집기 버전', datafield: 'vsvrEngVer', width: 100 }
				]
			}, CtxMenu.VSVR, ctxmenuIdx++);
		...
		/** 가상서버 조회 */
		searchHost: function() {
			HmGrid.updateBoundData($hostGrid, ctxPath + '/main/vsvr/vsvrStatus/getHostStatusList.do');
		},
		/** 상세정보 */
