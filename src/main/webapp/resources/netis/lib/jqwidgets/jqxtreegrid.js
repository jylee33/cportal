                            ...
                            if (l === "source") {
                                ...
                                if (l === "columns" || l === "columnGroups") {
                                    ...
                                    if (l === "rtl") {
                                        ...
                                        f.vScrollBar.jqxScrollBar({rtl: k});
                                        f.hScrollBar.jqxScrollBar({rtl: k});
                                        f._render()
                                    } else {
                                        if (l === "pagerMode") {
                                            d.pagerMode = k;
                                                    ...
                                                    if (l === "pagerPosition") {
                                                        ...
                                                        if (l === "selectionMode") {
                                                            ...
                                                            if (l == "touchmode") {
                                                                ...
                                                                f._removeHandlers();
                                                                f.touchDevice = null;
                                                                f.vScrollBar.jqxScrollBar({touchMode: k});
                                                                f.hScrollBar.jqxScrollBar({touchMode: k});
                                                                ...
                                                                if (l == "enableHover") {
                                                                    ...
                                                                    if (l == "disabled") {
                                                                        ...
                                                                        if (f.pageable) {
                                                                            if (f.pagernexttop) {
                                                                                f.pagernexttop.jqxButton({disabled: k});
                                                                                f.pagerprevioustop.jqxButton({disabled: k});
                                                                                f.pagernextbottom.jqxButton({disabled: k});
                                                                                f.pagerpreviousbottom.jqxButton({disabled: k});
                                                                                f.pagerfirsttop.jqxButton({disabled: k});
                                                                                f.pagerfirstbottom.jqxButton({disabled: k});
                                                                                f.pagerlasttop.jqxButton({disabled: k});
                                                                                f.pagerlastbottom.jqxButton({disabled: k});
                                                                        ...
                                                                        if (l == "columnsHeight") {
                                                                            ...
                                                                            if (l == "theme") {
                                                                                ...
                                                                                f.vScrollBar.jqxScrollBar({theme: f.theme});
                                                                                f.hScrollBar.jqxScrollBar({theme: f.theme});
                                                                                if (f.pageable && f.pagernexttop) {
                                                                                    f.pagernexttop.jqxButton({theme: f.theme});
                                                                                    f.pagerprevioustop.jqxButton({theme: f.theme});
                                                                                    f.pagernextbottom.jqxButton({theme: f.theme});
                                                                                    f.pagerpreviousbottom.jqxButton({theme: f.theme});
                                                                                    f.pagerfirsttop.jqxButton({theme: f.theme});
                                                                                    f.pagerfirstbottom.jqxButton({theme: f.theme});
                                                                                    f.pagerlasttop.jqxButton({theme: f.theme});
                                                                                    f.pagerlastbottom.jqxButton({theme: f.theme});
                                                                                    if (f.pagershowrowscombotop.jqxDropDownList) {
                                                                                        if (f.pagerMode == "advanced") {
                                                                                            f.pagershowrowscombotop.jqxDropDownList({theme: f.theme});
                                                                                            f.pagershowrowscombobottom.jqxDropDownList({theme: f.theme})
                                                                                        }
                                                                                    }
                                                                                }
                                                                                if (f.filterable) {
                                                                                    ...
                                                                                    if (b.length > 0) {
                                                                                        b.jqxDropDownList({theme: f.theme})
                                                                                    }
                                                                                    if (f.filtercolumnsList) {
                                                                                        f.filtercolumnsList.jqxDropDownList({theme: f.theme})
                                                                                    }
                                                                                }
                                                                                f.refresh()
                                                                            } else {
